	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
  		- Cookie정보 삭제하기 
  			...
  			==> 삭제할 쿠리를 찾은 후 해당 쿠키의 속성 중 유지시간을 0으로 변경한 후 다시 저장하는 방법을 사용한다.

		 */
		/*
		 *  1. 전체 쿠키 정보를 Request객체를 통해 가져온다.
		 * 		==>가져온 쿠키 정보들은 배열에 저장되어 반환된다.
		 * 형식) Cookie[] 배열 변수 = request.getCookies();
		 */
		...
		out.println("<body>");
		out.println("<h3>저장된 Cooie 데이터 삭제하기</h3>");
		out.println("<hr>");
